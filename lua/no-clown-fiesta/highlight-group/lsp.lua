...
function M.highlight(palette)
  return {
    ...
    LspDiagnosticsUnderlineWarning = { sp = nil, style = "NONE" },
    LspDiagnosticsUnderlineInformation = { sp = nil, style = "NONE" },
    LspDiagnosticsUnderlineInfo = { sp = nil, style = "NONE" },
    LspDiagnosticsUnderlineHint = { sp = nil, style = "NONE" },
