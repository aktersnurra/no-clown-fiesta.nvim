...
function M.highlight(palette)
  return {
    ...
    LspDiagnosticsUnderlineWarning = { fg = palette.bg, style = "underline" },
    LspDiagnosticsUnderlineInformation = { fg = palette.bg, style = "underline" },
    LspDiagnosticsUnderlineInfo = { fg = palette.bg, style = "underline" },
    LspDiagnosticsUnderlineHint = { fg = palette.bg, style = "underline" },
